              ...
              children: <Widget>[
                      ...
                      InkWell(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                image: NetworkImage(snapshot.data.documents[0]['photo']),
                                fit: BoxFit.cover,
                              ),
                        ...
                        Navigator.pushReplacement(
                            ...
                            new MaterialPageRoute(
                                ...
                                new Profile(snapshot.data.documents[0].documentID, user)
                            )
                        )
                        },
                      ),
                ...
                new ListTile(
                  ...
                  Navigator.push(
                      ctxt,
                      MaterialPageRoute(
                          builder: (ctxt) => InboxPage(snapshot.data.documents[0]['name'], snapshot.data.documents[0]['email'], user))
                  )
                  },
                ),
                new ListTile(
